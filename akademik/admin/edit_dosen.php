...
if(isset($_POST["submit"])) {
  ...
  $query = "UPDATE dosen SET
            nip = '$nip', nama_dosen = '$nama', gambar='$gambar' WHERE nip = '$nip'";

  mysqli_query($conn, $query);

  if(mysqli_affected_rows($conn) > 0) {
    echo "<script>alert('Data Dosen Berhasil Diubah!');document.location.href = 'dosen.php';</script>";
  } else {
    ...
    <nav>
      ...
      <section id="breadcrumb">
        <div class="container">
          ...
          <p class="breadcrumb-text"><a href="home.php">Home</a> &rsaquo; <a href="dosen.php">Database Dosen</a> &rsaquo; Edit Data Dosen</p>
          </div>
        </div>
      </section>
...
<div class="container text-left mb-4 form">
      ...
      <h4 class="text-left"> Ubah Data Dosen </h4> <hr> <br>

      <form action="" method="post" enctype="multipart/form-data">
        <input type="hidden" name="gambar_lama" value="<?= $dosen["gambar"]; ?>">
        <h6>1. Masukkan NIP Dosen :</h6>
          <div class="form-floating mb-3">
          <input type="text" name="nip" id="nip" class="form-control" placeholder="Masukkan NIP Dosen" value="<?= $dosen["nip"]; ?>" required>
          <label for="nip">NIP</label>
        </div>
        <br>
        <h6>2. Masukkan Nama Dosen :</h6>
        <div class="form-floating mb-3">
            <input type="text" name="nama" id="nama" class="form-control" placeholder="Masukkan Nama Dosen" value="<?= $dosen["nama_dosen"]; ?>" required>
            <label for="nama">Nama Dosen</label>
        </div>
        <br>
        <div><img src="../images/<?= $dosen["gambar"] ?>"></div>
        <br>
