...
if(isset($_POST["submit"])) {
  ...
  if(mysqli_affected_rows($conn) > 0) {
    echo "<script>alert('Data Mata Kuliah Berhasil Ditambahkan!');document.location.href = 'matkul.php';</script>";
  } else {
    ...
    <nav>
      ...
      <section id="breadcrumb">
        <div class="container">
          ...
          <p class="breadcrumb-text"><a href="home.php">Home</a> &rsaquo; <a href="matkul.php">Database Mata Kuliah</a> &rsaquo; Tambah Data Mata Kuliah</p>
          </div>
        </div>
      </section>
...
<div class="container text-left mb-4 form">
      <h1 class="text-center text-gradient"> <i class="fa fa-book-reader"> </i></h1>
      <h4 class="text-left"> Tambah Data Mata Kuliah </h4> <hr> <br>

      <form action="" method="post">
        <h6>1. Masukkan Kode Mata Kuliah :</h6>
          <div class="form-floating mb-3">
          <input type="text" name="kode_mk" id="kode_mk" class="form-control" placeholder="Masukkan Kode Mata Kuliah" required>
          <label for="kode_mk">Kode Mata Kuliah</label>
        </div>
        <br>
        <h6>2. Masukkan Nama Mata Kuliah :</h6>
        <div class="form-floating mb-3">
            <input type="text" name="nama" id="nama" class="form-control" placeholder="Masukkan Nama Mata Kuliah" required>
            <label for="nama">Nama Mata Kuliah</label>
        </div>
        <br>
        <h6>3. Masukkan Jumlah Mata Kuliah :</h6>
        <div class="form-floating mb-3">
            <input type="text" name="sks" id="sks" class="form-control" placeholder="Masukkan Jumlah SKS" required>
