...
if(isset($_POST["submit"])) {
  ...
  // die;
    ...
    for ($i=1; $i < count($dataArray); $i++) {
      ...
      $nim = $dataArray[$i]['0'];
      $nama = $dataArray[$i]['1'];
      $tgl_lahir = $dataArray[$i]['2'];
      $alamat = $dataArray[$i]['3'];
      $jenis_kelamin = $dataArray[$i]['4'];
    }
    ...
    <nav>
      ...
      <section id="breadcrumb">
        <div class="container">
          ...
          <p class="breadcrumb-text"><a href="home.php">Home</a> &rsaquo; <a href="mahasiswa.php">Database Mahasiswa</a> &rsaquo; Import Data Mahasiswa</p>
          </div>
        </div>
      </section>
...
<div class="container text-left mb-4 form">
      ...
      <h4 class="text-left"> Import Data Mahasiswa </h4> <hr> <br>
