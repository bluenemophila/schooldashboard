...
if(isset($_POST["submit"])) {
  ...
  // die;
    ...
    for ($i=1; $i < count($dataArray); $i++) {
      ...
      $username = $dataArray[$i]['1'];
      $password = md5($dataArray[$i]['2']);
      $name = $dataArray[$i]['3'];
      $level = $dataArray[$i]['4'];
    }
    ...
    <nav>
      ...
      <section id="breadcrumb">
        <div class="container">
          ...
          <p class="breadcrumb-text"><a href="home.php">Home</a> &rsaquo; <a href="users.php">Manajemen User</a> &rsaquo; Import Data User</p>
          </div>
        </div>
      </section>
...
<div class="container text-left mb-4 form">
      ...
      <h4 class="text-left"> Import Data User </h4> <hr> <br>
