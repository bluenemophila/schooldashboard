...
$perkuliahan = query("SELECT * FROM perkuliahan");
    ...
    <nav>
      ...
      <div class="stickynav-container">
        <nav>
          <ul>
            ...
            <div class="dropdown5">
            <li class="active"><a class="dropbutton3"><i class="fas fa-university nav-fa-icon icon"></i>Database Perkuliahan  <i class="fas fa-sort-down"></i></a></li>
      ...
      <section id="breadcrumb">
        <div class="container">
          ...
          <p class="breadcrumb-text"><a href="home.php">Home</a> &rsaquo; <a href="perkuliahan.php">Database Perkuliahan</a> &rsaquo; Tambah Data Perkuliahan</p>
          </div>
        </div>
      </section>
...
<div class="container text-left mb-4 form">
      ...
      <h4 class="text-left"> Tambah Data Perkuliahan </h4> <hr> <br>

      <form action="" method="post">
        <h6>1. Masukkan NIM Mahasiswa :</h6>
          <div class="form-floating mb-3">
          <select class="form-select" name="nim" id="nim" required>
            <option selected>Masukkan NIM</option>
              <?php $i = 1; ?>
                <?php foreach($mahasiswa as $pilih) : ?>
                  <option value=<?= $pilih["nim"] ?>><?= $pilih["nim"] ?></option>
                  <?php $i++; ?>
                  <?php endforeach; ?>
          </select>
        ...
        <h6>2. Masukkan Kode Mata Kuliah :</h6>
          ...
          <select class="form-select" name="kode_mk" id="kode_mk" required>
            <option selected>Masukkan Kode Mata Kuliah</option>
              <?php $i = 1; ?>
                <?php foreach($matkul as $pilih1) : ?>
                  <option value=<?= $pilih1["kode_mk"] ?>><?= $pilih1["kode_mk"] ?></option>
                  <?php $i++; ?>
                  <?php endforeach; ?>
          </select>
        ...
        <h6>3. Masukkan NIP Dosen :</h6>
          ...
          <select class="form-select" name="nip" id="nip" required>
            <option selected>Masukkan NIP Dosen</option>
              <?php $i = 1; ?>
                <?php foreach($dosen as $pilih2) : ?>
                  <option value=<?= $pilih2["nip"] ?>><?= $pilih2["nip"] ?></option>
                  <?php $i++; ?>
                  <?php endforeach; ?>
          </select>
        ...
        <div class="form-floating mb-3">
          <input type="text" name="nilai" id="nilai" class="form-control" placeholder="Masukkan Nilai Mahasiswa" required>
