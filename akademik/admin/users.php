...
<section id="content">
  ...
  <div>
  <h3><i class="fa fa-users"> </i> Tabel Data User <hr></h3><br>
  </div>
  </div>
<!-- endtitle -->
      ...
      <div class="baris4">
      <div class="tambah">
        <a href="tambah_user.php" class="btn btn-primary btn-lg"><i class="fa fa-plus-square icon"></i>Tambah Data User</a>
      </div>
        <div class="">
        <a href="import_user.php" class="btn btn-primary btn-lg"><i class="fa fa-file-import icon"></i>Import Datasheet</a>
      </div>
      </div>
    ...
    <h5>Total <?= $jumlahdata ?> Jumlah User</h5>
