...
$users = query("SELECT * FROM users WHERE username = '$username'")[0];
...
if(isset($_POST["submit"])) {
  ...
  $query = "UPDATE users SET
            username = '$username', name = '$nama', level = '$level' WHERE username = '$username'";
    ...
    <nav>
      ...
      <section id="breadcrumb">
        <div class="container">
          ...
          <p class="breadcrumb-text"><a href="home.php">Home</a> &rsaquo; <a href="users.php">Manajemen User</a> &rsaquo; Edit Data User</p>
          </div>
        </div>
      </section>
...
<div class="container text-left form">
      <h1 class="text-center text-gradient"> <i class="fa fa-users"> </i></h1>
      <h4 class="text-left"> Ubah Data Users </h4> <hr> <br>

      <form action="" method="post">
        <h6>1. Masukkan Username :</h6>
          <div class="form-floating mb-3">
          <input type="text" name="username" id="username" class="form-control" placeholder="Masukkan Username" value="<?= $users["username"]; ?>" required>
          <label for="username">Username</label>
        </div>
        <br>
        <h6>2. Masukkan Nama User:</h6>
        <div class="form-floating mb-3">
            <input type="text" name="nama" id="nama" class="form-control" placeholder="Masukkan Nama User" value="<?= $users["name"]; ?>" required>
            <label for="nama">Nama User</label>
        </div>
        <br>
        <h6>3. Masukkan Level User :</h6>
          <div class="form-floating mb-3">
          <select class="form-select" name="level" id="level" value="<?= $users["level"]; ?>" required>
