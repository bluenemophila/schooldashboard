    ...
    <nav>
      ...
      <section id="breadcrumb">
        <div class="container">
          ...
          <p class="breadcrumb-text"><a href="home.php">Home</a> &rsaquo; Database Dosen</p>
          </div>
        </div>
      </section>
...
<section id="content">
  ...
  <div>
  <h3><i class="fa fa-chalkboard-teacher"> </i> Tabel Data Dosen <hr></h3><br>
  </div>
  </div>
<!-- endtitle -->
      ...
      <div class="baris4">
      <div class="tambah">
        <a href="tambah_dosen.php" class="btn btn-primary btn-lg"><i class="fa fa-plus-square icon"></i>Tambah Data Dosen</a>
      </div>
        <div class="">
        <a href="import_dosen.php" class="btn btn-primary btn-lg"><i class="fa fa-file-import icon"></i>Import Datasheet</a>
      </div>
      </div>
      ...
      <div class="srch">
        <form class="d-flex justify-content-end md-form form-sm active-cyan active-cyan-2 mt-2" action="dosen_cari.php" method="post">
        ...
        <table class="table table-striped table-bordered table-hover">
          <thead class="text-center table-dark align-middle">
            <tr>
              ...
              <th scope="col">NIP</th>
              <th scope="col">Nama<br>Dosen</th>
              <th colspan="2" scope="col" class="w-auto">Aksi</th>
            </tr>
          </thead>
        ...
        <?php $i = $awaldata + 1; ?>
          <?php foreach($dosen as $baris) : ?>
            <tr class="text-center align-middle">
              <td><?= $i; ?></td>
              <td><img src="../images/<?= $baris["gambar"] ?>"></td>
              <td><?= $baris["nip"] ?></td>
              <td><?= $baris["nama_dosen"] ?></td>
              <td class="text-center"><a href="edit_dosen.php?nip=<?= $baris["nip"] ?>"><button type="button" class="btn btn-success"><i class="fa fa-edit"></i> Edit</button></a></td>
              <td class="text-center"><a href="hapus_dosen.php?nip=<?= $baris["nip"] ?>" onclick="return confirm('Apakah anda yakin untuk menghapus?')";><button type="button" class="btn btn-danger"><i class="fa fa-trash-alt"></i> Hapus</button></a></td>
            </tr>
            <?php $i++; ?>
          <?php endforeach; ?>
        </table>
