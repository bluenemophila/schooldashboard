...
$awaldata = ($jumlahdataperhalaman * $halaman) - $jumlahdataperhalaman;
  ...
  $perkuliahan = query("SELECT * FROM perkuliahan LEFT JOIN mahasiswa ON perkuliahan.nim_mhs = mahasiswa.nim LEFT JOIN matakuliah ON perkuliahan.kode_matkul = matakuliah.kode_mk LEFT JOIN dosen ON perkuliahan.nip_dosen = dosen.nip LIMIT $awaldata, $jumlahdataperhalaman");
...
if( isset($_POST['cari'])) {
  ...
  $field = $kolom;
    ...
    if($field === "Cari Berdasarkan") {
      echo ("<script>alert('Field tidak boleh kosong!'); document.location.href = 'perkuliahan.php';</script>");
      exit;
    }
} else {
  ...
  $awaldata = ($jumlahdataperhalaman * $halaman) - $jumlahdataperhalaman;
    ...
    $perkuliahan = query("SELECT * FROM perkuliahan LEFT JOIN mahasiswa ON perkuliahan.nim_mhs = mahasiswa.nim LEFT JOIN matakuliah ON perkuliahan.kode_matkul = matakuliah.kode_mk LEFT JOIN dosen ON perkuliahan.nip_dosen = dosen.nip WHERE
