    ...
    <nav>
      ...
      <section id="breadcrumb">
        <div class="container">
          ...
          <p class="breadcrumb-text"><a href="home.php">Home</a> &rsaquo; <a href="users.php">Manajemen User</a> &rsaquo; Tambah Data User</p>
          </div>
        </div>
      </section>
...
<div class="container text-left mb-4 form">
      ...
      <form action="" method="post">
        ...
        <button type="submit" name="signup" class="btn btn-primary btn-lg"><i class="fas fa-sign-in-alt icon"></i>Daftarkan User</button>
        </div>
