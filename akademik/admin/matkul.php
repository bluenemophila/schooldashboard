...
<!-- endtitle -->
      ...
      <div class="baris4">
      <div class="tambah">
        <a href="tambah_matkul.php" class="btn btn-primary btn-lg"><i class="fa fa-plus-square icon"></i>Tambah Data Mata Kuliah</a>
      </div>
        <div class="">
        <a href="import_matkul.php" class="btn btn-primary btn-lg"><i class="fa fa-file-import icon"></i>Import Datasheet</a>
      </div>
      </div>
        ...
        <?php $i = $awaldata + 1; ?>
          <?php foreach($matkul as $baris) : ?>
            <tr class="text-center align-middle">
              ...
              <td><?= $baris["nama_mk"] ?></td>
              <td><?= $baris["sks"] ?></td>
              <td class="text-center"><a href="edit_matkul.php?kode_mk=<?= $baris["kode_mk"] ?>"><button type="button" class="btn btn-success"><i class="fa fa-edit"></i> Edit</button></a></td>
              <td class="text-center"><a href="hapus_matkul.php?kode_mk=<?= $baris["kode_mk"] ?>" onclick="return confirm('Apakah anda yakin untuk menghapus?')";><button type="button" class="btn btn-danger"><i class="fa fa-trash-alt"></i> Hapus</button></a></td>
            </tr>
            <?php $i++; ?>
          <?php endforeach; ?>
        </table>
