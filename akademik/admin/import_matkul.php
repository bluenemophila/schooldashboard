...
if(isset($_POST["submit"])) {
  ...
  // die;
    ...
    for ($i=1; $i < count($dataArray); $i++) {
      ...
      $kode_mk = $dataArray[$i]['0'];
      $nama_mk = $dataArray[$i]['1'];
      $sks = $dataArray[$i]['2'];
    }
    ...
    <nav>
      ...
      <section id="breadcrumb">
        <div class="container">
          ...
          <p class="breadcrumb-text"><a href="home.php">Home</a> &rsaquo; <a href="matkul.php">Database Mata Kuliah</a> &rsaquo; Import Data Mata Kuliah</p>
          </div>
        </div>
      </section>
...
<div class="container text-left mb-4 form">
      ...
      <h4 class="text-left"> Import Data Mata Kuliah </h4> <hr> <br>
