    ...
    <nav>
      ...
      <section id="breadcrumb">
        <div class="container">
          ...
          <p class="breadcrumb-text"><a href="home.php">Home</a> &rsaquo; Profil Dosen</p>
          </div>
        </div>
      </section>
...
<section id="content">
  ...
  <div>
  <h3><i class="fa fa-chalkboard-teacher"> </i> Profil Dosen <hr></h3><br>
  </div>
  </div>
<!-- endtitle -->

          <div class="col-sm-12 align-items-center d-flex justify-content-center profil">
          <img src="../images/<?= $row['gambar'] ?>" width="200px" height="200px" class="rounded-circle">
          </div>
