...
if( isset($_POST['cari'])) {
  ...
  $field = $kolom;
    ...
    if($field === "Cari Berdasarkan") {
      echo ("<script>alert('Field tidak boleh kosong!'); document.location.href = 'mahasiswa.php';</script>");
      exit;
    }
} else {
  ...
  $awaldata = ($jumlahdataperhalaman * $halaman) - $jumlahdataperhalaman;
    ...
    $mhs = query("SELECT * FROM mahasiswa WHERE
...
<section id="content">
  ...
  <div class="d-flex justify-content-start">
        <div class="col-6">
        <a href="mahasiswa.php" class="btn btn-primary btn-lg"><i class="fa fa-arrow-left mr-5"></i>  Kembali</a>
        </div>
  </div>
<!-- endtitle -->
