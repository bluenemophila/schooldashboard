...
$nama = $_SESSION['nama'];
  ...
  $baris = query("SELECT * FROM perkuliahan INNER JOIN mahasiswa ON perkuliahan.nim_mhs = mahasiswa.nim INNER JOIN matakuliah ON perkuliahan.kode_matkul = matakuliah.kode_mk INNER JOIN dosen ON perkuliahan.nip_dosen = dosen.nip WHERE mahasiswa.nama_mhs = '$nama'");
    ...
    <nav>
      ...
      <section id="breadcrumb">
        <div class="container">
          ...
          <p class="breadcrumb-text"><a href="home.php">Home</a> &rsaquo; Mata Kuliah Semester Ini</p>
          </div>
        </div>
      </section>
...
<section id="content">
  ...
  <div>
  <h3><i class="fa fa-user-graduate"> </i>  Mata Kuliah Semester Ini <hr></h3><br>
  </div>
  </div>
<!-- endtitle -->
         ...
         <div class="col-sm-12 align-items-center d-flex justify-content-center profil-text">
          <h4><?= $baris[0]["nama_mhs"] ?> - <?= $baris[0]["nim_mhs"] ?></h4>
        </div>
